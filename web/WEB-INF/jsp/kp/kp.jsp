	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="kpform" method="post" id="kpform" action="${ctx}/kp/selectKP">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	知识点名称：<input type="text" name="name">
		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.kps}" var="kp" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" >
					...
					<%--<td>${kp.doc}</td>--%>
					<td align="center" width="40px;"><a href="${ctx}/kp/updateKP?flag=1&id=${kp.id}">
							<img title="修改知识点信息" src="${ctx}/images/update.gif"/></a>
					 </td>
					<td align="center" width="40px;">
						<a href="${ctx}/kpr/selectKPR?flag=1&id=${kp.id}">查看关联知识点</a>
					</td>
				</tr>
			</c:forEach>
		  </table>
