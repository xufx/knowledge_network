...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：知识点管理  &gt; 修改知识点</td>
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/kp/updateKP" id="kpForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
					<tr>
						<td class="font3 fftd">知识点名称：<input type="text" name="name" id="name" size="30" value="${kp.name}"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="font3 fftd">学习文档：<input type="text" name="doc" id="doc" size="20" value="${kp.doc}"/></td>
					</tr>
					<tr>
						<td class="font3 fftd">学习视频：<input type="text" name="video" id="video" size="20" value="${kp.video}"/></td>
					</tr>
					<tr>
