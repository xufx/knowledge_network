...
!1,c=0,d=h.greedy,e=h.repeat;1==a.length&&!1==d&&(h.placeholder="");for(var a=f.map(a.split(""),function(a){var s=[];if(a==h.escapeChar)b=true;else if(a!=h.optionalmarker.start&&a!=h.optionalmarker.end||b){var d=h.contents[a];if(d&&!b)for(a=0;a<d.cardinality;a++)s.push(G(c+a));else{s.push(a);b=false}c=c+s.length;return s}}),j=a.slice(),y=1;y<e&&d;y++)j=j.concat(a.slice());return{mask:j,repeat:e,greedy:d}}function l(a){var b=!1,c=!1,d=!1;return f.map(a.split(""),function(a){var s=[];if(a==h.escapeChar)c=
!0;else if(a==h.optionalmarker.start&&!c)d=b=!0;else if(a==h.optionalmarker.end&&!c)b=!1,d=!0;else{var e=h.contents[a];if(e&&!c){for(var f=e.prevalidator,j=f?f.length:0,l=1;l<e.cardinality;l++){var g=j>=l?f[l-1]:[],k=g.validator,g=g.cardinality;s.push({fn:k?"string"==typeof k?RegExp(k):new function(){this.test=k}:/./,cardinality:g?g:1,optionality:b,newBlockMarker:!0==b?d:!1,offset:0,casing:e.casing,def:e.contentSymbol|a});!0==b&&(d=!1)}s.push({fn:e.validator?"string"==typeof e.validator?RegExp(e.validator):
new function(){this.test=e.validator}:/./,cardinality:e.cardinality,optionality:b,newBlockMarker:d,offset:0,casing:e.casing,def:e.contentSymbol|a})}else s.push({fn:null,cardinality:0,optionality:b,newBlockMarker:d,offset:0,casing:null,def:a}),c=!1;d=!1;return s}})}function u(){function a(c,d){var e=0,f=0,y=d.length;for(i=0;i<y&&!(d.charAt(i)==h.optionalmarker.start&&e++,d.charAt(i)==h.optionalmarker.end&&f++,0<e&&e==f);i++);e=[d.substring(0,i)];i<y&&e.push(d.substring(i+1,y));var m,f=e[0];m=f.length;
...
"return;"),c="function"==typeof b[a]);return c}("paste")?"paste":"input",aa=null!=navigator.userAgent.match(/iphone/i),V=null!=navigator.userAgent.match(/android.*safari.*/i),$;if(V){var ca=navigator.userAgent.match(/safari.*/i);$=533>=parseInt(RegExp(/[0-9]+/).exec(ca))}var q,o=0;if("string"==typeof a)switch(a){case "mask":return b(h.alias,d),q=u(),this.each(function(){P(this)});case "unmaskedvalue":return q=this.data("inputmask").masksets,o=this.data("inputmask").activeMasksetIndex,h.contents=
this.data("inputmask").contents,Z(this);case "remove":return this.each(function(){var a=f(this),b=this;setTimeout(function(){if(a.data("inputmask")){q=a.data("inputmask").masksets;o=a.data("inputmask").activeMasksetIndex;h.contents=a.data("inputmask").contents;b._valueSet(Z(a,!0));a.removeData("inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var c;Object.getOwnPropertyDescriptor&&(c=Object.getOwnPropertyDescriptor(b,"value"));c&&c.get?b._valueGet&&Object.defineProperty(b,
...
this.data("inputmask").masksets,o=this.data("inputmask").activeMasksetIndex,h.contents=this.data("inputmask").contents,S(this[0].split(""));default:return b(a,d)||(h.mask=a),q=u(),this.each(function(){P(this)})}else{if("object"==typeof a)return h=f.extend(!0,{},f.inputmask.defaults,a),b(h.alias,a),q=u(),this.each(function(){P(this)});if(void 0==a)return this.each(function(){var a=f(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),c=f.parseJSON("{"+a+"}");h=f.extend(!0,
{},f.inputmask.defaults,c);b(h.alias,c);h.alias=void 0;f(this).inputmask(h)}catch(d){}})}return this})})(jQuery);
(function(f){f.extend(f.inputmask.defaults.contents,{A:{validator:"[A-Za-z]",cardinality:1,casing:"upper"},"#":{validator:"[A-Za-z\u0410-\u044f\u0401\u04510-9]",cardinality:1,casing:"upper"}});f.extend(f.inputmask.defaults.aliases,{url:{mask:"ir",placeholder:"",separator:"",defaultPrefix:"http://",regex:{urlpre1:/[fh]/,urlpre2:/(ft|ht)/,urlpre3:/(ftp|htt)/,urlpre4:/(ftp:|http|ftps)/,urlpre5:/(ftp:\/|ftps:|http:|https)/,urlpre6:/(ftp:\/\/|ftps:\/|http:\/|https:)/,urlpre7:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/)/,
urlpre8:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/\/)/},contents:{i:{validator:function(){return!0},cardinality:8,prevalidator:function(){for(var a=[],d=0;8>d;d++)a[d]=function(){var a=d;return{validator:function(d,b,j,f,u){if(u.regex["urlpre"+(a+1)]){var z=d;0<a+1-d.length&&(z=b.join("").substring(0,a+1-d.length)+""+z);d=u.regex["urlpre"+(a+1)].test(z);if(!f&&!d){j-=a;for(f=0;f<u.defaultPrefix.length;f++)b[j]=u.defaultPrefix[f],j++;for(f=0;f<z.length-1;f++)b[j]=z[f],j++;return{pos:j}}return d}return!1},
cardinality:a}}();return a}()}},insertMode:!1,autoUnmask:!1},ip:{mask:"i.i.i.i",contents:{i:{validator:"25[0-5]|2[0-4][0-9]|[01][0-9][0-9]",cardinality:3,prevalidator:[{validator:"[0-2]",cardinality:1},{validator:"2[0-5]|[01][0-9]",cardinality:2}]}}}})})(jQuery);
(function(f){f.extend(f.inputmask.defaults.contents,{h:{validator:"[01][0-9]|2[0-3]",cardinality:2,prevalidator:[{validator:"[0-2]",cardinality:1}]},s:{validator:"[0-5][0-9]",cardinality:2,prevalidator:[{validator:"[0-5]",cardinality:1}]},d:{validator:"0[1-9]|[12][0-9]|3[01]",cardinality:2,prevalidator:[{validator:"[0-3]",cardinality:1}]},m:{validator:"0[1-9]|1[012]",cardinality:2,prevalidator:[{validator:"[01]",cardinality:1}]},y:{validator:"(19|20)\\d{2}",cardinality:4,prevalidator:[{validator:"[12]",
